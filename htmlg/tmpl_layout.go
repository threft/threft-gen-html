...
<html lang="en">
	...
	tmplFooter, err = template.New("footer").Parse(`
			...
			<footer>
				<p>
					Generated by threft-gen-html &bull; <a href="http://threft.github.io" >threft.github.io</a> &bull; Uses <a href="http://twitter.github.com/bootstrap/" target="_blank">Twitter Bootstrap</a>
				</p>
			</footer>
		</div>
	</body>
